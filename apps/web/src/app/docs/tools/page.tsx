...
import { ToolsDecorativeElements } from "@/components/tools-decorative";
...
const tools = [
  // Image Tools
  {
    ...
    modelUrl: "https://fal.ai/models?q=text-to-image",
  },
  {
    id: "imageToImage",
    name: "Image to Image",
    ...
    modelUrl: "https://fal.ai/models?q=image-to-image",
  },
  {
  ...
  // Video Tools
  {
    ...
    modelUrl: "https://fal.ai/models?q=text-to-video",
  },
  {
    id: "imageToVideo",
    name: "Image to Video",
    ...
    modelUrl: "https://fal.ai/models?q=image-to-video",
  },
  ...
  // Audio Tools
  {
    ...
    modelUrl: "https://fal.ai/models?q=text-to-audio",
  },
  {
    id: "speechToText",
    name: "Speech to Text",
    ...
    modelUrl: "https://fal.ai/models?q=audio-to-text",
  },
  {
    id: "textToAudio",
    name: "Text to Audio",
  ...
  },
  {
    ...
    modelUrl: "https://fal.ai/models?q=audio-to-audio",
  },
  ...
  },
  {
    ...
    modelSupport: "All models",
    modelUrl: "https://fal.ai/models?q=training",
  },
  {
...
export default function ToolsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        <FloatingHeader />
        <ToolsDecorativeElements />

        {/* Main content - account for header height and margin */}
        <div className="pt-40 pb-24">
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-12">
              <h1 className="text-5xl font-heading font-extralight text-gray-900 mb-4 tracking-[-0.02em]">Tools Reference</h1>
            ...
            <div className="relative mb-8 -mx-6">
              ...
              >
                <Button
                  ...
                  className="flex-shrink-0 border-gray-300 hover:border-gray-400"
                >
                  All ({tools.length})
                </Button>
                {categories.map((category) => {
                  ...
                  return (
                    <Button
                      ...
                      className="flex-shrink-0 gap-1.5 border-gray-300 hover:border-gray-400"
                    >
                      {mostCommonType && <ModelTypeBadge modelType={mostCommonType} className="mr-1" />}
                      {category} ({count})
                    </Button>
                  );
                })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
              {filteredTools.map((tool) => (
                <div 
                  key={tool.id} 
                  className="group p-6 border border-gray-200 rounded-[0.25rem] hover:border-gray-400 hover:shadow-sm transition-all duration-150 bg-white"
                >
                  <div className="mb-3">
                    <h3 className="font-mono text-sm font-semibold text-gray-900 mb-2 group-hover:text-gray-800">{tool.id}</h3>
                    <div className="flex items-center gap-2 flex-wrap">
                      {tool.modelType && <ModelTypeBadge modelType={tool.modelType} />}
                  ...
                  <p className="text-xs text-gray-500 font-medium">
                    Models: {tool.modelUrl ? (
                      ...
                      <span className="text-gray-600">{tool.modelSupport}</span>
                    )}
                  </p>
                </div>
              ))}
